                ...
                <div class="col-lg-8">
                    <div class="blog__details__title">
                        ...
                        <div class="blog__details__social">
                            <a href="myinfo.html" class="facebook"><i class="fa fa-arrow-left"></i> 개인정보</a>
                            <a href="membership.html" class="facebook" style="text-align: center;">&nbsp;멤버쉽&nbsp;&nbsp;&nbsp; <i class="fa fa-arrow-right"></i> </a>
                        ...
                        <div class="blog__details__btns">
                          ...
                          <!--  <div class="blog__details__comment">
                            ...
                            <div class="blog__details__form">
                                <h4>예약 현황</h4>
                                <form name="11" method="post" action="/mypage/api/Findresv.php">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <table class="resvtable">
                                              ...
                                              $R_Number=$_GET['rownumber'];
                                                ...
                                                $CID = array();
                                                $CID1= array();
                                                $CID1= unserialize($_SESSION["date1"]);
                                                ...
                                                for($i=0;$i<$R_Number;$i++){
                                                  ...
                                                  <td> $CID[$i] ~ $CID1[$i]</td>
                                                  <td></td>
                                                  <td><input type='submit' name='cancel' value='$i+1'></td>
                                                  </tr>");
                                                }; ?>
                                            </table>
